...
<p style="text-align: right;"> 
    ...
    <a href="/user/{search}" class="text-white mr-2 header-search-icon" title="Search" data-toggle="tooltip" data-placement="bottom"><i class="fas fa-search" style="color: red; "></i></a>
 
    {{-- <img src="{{asset('images/search.webp')}}" class="text-white mr-2 header-search-icon"  alt="" title="Search" data-toggle="tooltip" data-placement="bottom" width="50px;"> --}}
    {{-- <a href="#" class="text-white mr-2 header-search-icon" ><i class="fas fa-search" style="color: red; "></i></a> --}}
</p>
            <div class="card mb-4">
